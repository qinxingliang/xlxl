...
public class MybatisPlusGenerator {
    ...
    // 配置数据库信息
    private static final String URL = "jdbc:mysql://git.qiufengluoyue.cn:3306/lajifenlei?serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8&nullCatalogMeansCurrent=true";
    private static final String USERNAME = "root";
    private static final String PASSWORD = "jiarui19971224.";
    // 项目根目录
    private static final String PROJECT_ROOT_PATH = System.getProperty("user.dir");
    private static final String BASE_PATH = PROJECT_ROOT_PATH + "/src/main/java/project";
    private static final String PARENT_PACKAGE_NAME = "project";
...
//                        .formatFileName("%PO")
                        ...
                        // 格式化 mapper 文件名称。
                        // 如果不设置，如表[sys_user]，默认的文件a名是[SysUserMapper]。写成下面这种形式后，将变成[SysUserDao]。
