        ...
        init: function(a) {
            ...
            if (1 < t[0] || 1 === t[0] && 9 < t[1] || 1 === t[0] && 9 === t[1] && 91 <= t[2]) {
                ...
                echarts.setCanvasCreator(function() {
                    ...
                    "function" == typeof a ? e.chart = a(r, t.width, t.height) : e.data.ec && "function" == typeof e.data.ec.onInit ? e.chart = e.data.ec.onInit(r, t.width, t.height) : e.triggerEvent("init", {
                        canvas: r,
                        width: t.width,
                        height: t.height
                    });
