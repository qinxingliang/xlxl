            ...
            <el-scrollbar max-height="540px">
                <el-form :model="form" :rules="rules" ref="form" label-position="top">
                    ...
                    <el-form-item label="内容" prop="cContent">
                        <div style="width: 100%;">
                            <TEditor ref="editor" v-model:tinymceHtml="form.cContent" :height="400" />
                        </div>
                    </el-form-item>
